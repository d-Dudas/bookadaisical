...
public class UserController {
    ...
    public ResponseEntity<?> changeProfilePicture(@RequestBody ChangeProfilePictureDto changeProfilePictureDto)
    {
        try {
            userService.changeProfilePicture(changeProfilePictureDto);
